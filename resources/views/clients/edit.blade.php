                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('clients.create') }}" method="post">
                            ...
                            <div class="mb-3">
                                <label for="identification card" class="form-label">Identification card</label>
                                <input type="number" name="identification card" id="identification card" class="form-control" placeholder="Enter identification card">
                                @error('name')
                                <div class="text-danger">{{$message}}</div>
                                @enderror
                            </div>
